...
export declare class GetSelectorWriter<I, V> extends Writer {
    ...
    static write<I, V>(output: Output, recon: ReconWriter<I, V>, key: V, then: V, part?: Writer, step?: number): Writer;
    static writeThen<I, V>(output: Output, recon: ReconWriter<I, V>, key: V, then: V): Writer;
}
//# sourceMappingURL=GetSelectorWriter.d.ts.map